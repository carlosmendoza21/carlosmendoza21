...
🎮 Currently building an AI model that competes in competitive video games — designing real-time decision systems that operate at human reaction speed.
🌱 Going deep on reinforcement learning, game-state modeling, and low-latency inference.
...
**Focus areas** · Reinforcement learning · REST & GraphQL APIs · Real-time systems · Model training & deployment

---

### 🚀 Featured projects

**[GameAgent](#)** — Reinforcement learning agent trained to compete at a high level in competitive video games. Built with PyTorch, real-time game-state inference, and a custom reward modeling pipeline.
